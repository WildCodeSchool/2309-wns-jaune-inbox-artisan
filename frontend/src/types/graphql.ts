...
export type LoginQuery = { __typename?: 'Query', login: { __typename?: 'Message', success: boolean, message: string, user?: { __typename?: 'LoginResponse', id: string, username?: string | null, expirationDate: string } | null } };
