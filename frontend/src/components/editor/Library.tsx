...
const data = [
  ...
  {
    title: 'Card', definition: 'card with title and content', name: "MailCard", component: <MailCard title='simple card' style={{}} content={"<p>Card content</p><p>Card content</p><p>Card content</p>"}>
    </MailCard>
  },
  { title: 'Text list', definition: 'list with items', name: 'MailList', component: <MailList title='List example' style={{}} items={["example 1 ", "example 2"]}></MailList>,  keys : {} },
