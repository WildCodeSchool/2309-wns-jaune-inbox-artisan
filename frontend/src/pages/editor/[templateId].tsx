	...
	return (
      ...
      <SetupModal isOpen={isModalOpen} closeModal={() => setIsModalOpen(false)} />
			...
			<Layout className='h-[calc(100vh-14vh)] w-full'>
                ...
                <Sider theme="light" className='border border-gray-100 border-solid rounded-lg overflow-y-auto select-none shadow-[0_3px_10px_rgb(0,0,0,0.2)]' width="20%">
				    <Library></Library>
                </Sider>
                ...
                <Sider theme="light" className='h-full overflow-auto select-none rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)]' width="300px" collapsible collapsedWidth="20%" reverseArrow>
